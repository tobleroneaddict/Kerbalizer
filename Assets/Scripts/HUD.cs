...
public class HUD : MonoBehaviour
{
	...
	{
		sharingGroup = new Rect((float)Screen.width - (float)Screen.width * sharingGroupPercentWidth * 0.01f, (float)Screen.height - (float)Screen.height * sharingGroupPercentHeight * 0.01f, (float)Screen.width * sharingGroupPercentWidth * 0.01f, (float)Screen.height * sharingGroupPercentHeight * 0.01f);
		editorOptionsGroup = new Rect((float)Screen.width * 0.04f, (float)Screen.height * 0.1f, (float)Screen.width * editorOptionsPercentWidth * 0.01f, (float)Screen.height * editorOptionsPercentHeight * 0.01f);
		editorTypeControlGroup = new Rect((float)Screen.width * 0.01f, (float)Screen.height * 0.01f, (float)Screen.width * editorTypeControlPercentWidth * 0.01f, (float)Screen.height * editorTypeControlPercentHeight * 0.01f);
		buttonChangeType1 = new Rect(0f, 0f, 0f, 0f);
		editorRect = new Rect((float)Screen.width * 0.01f, (float)Screen.height * 0.01f, (float)Screen.width * editorTypeControlPercentWidth * 0.01f + (float)Screen.width * 0.016f, (float)Screen.height * 0.98f);
		buttonTypeControl1 = new Rect(0f, 0f, editorTypeControlGroup.width * 0.125f, editorTypeControlGroup.height);
		buttonTypeControl2 = new Rect(editorTypeControlGroup.width * 0.125f, 0f, editorTypeControlGroup.width * 0.125f, editorTypeControlGroup.height);
		buttonTypeControl3 = new Rect(editorTypeControlGroup.width * 0.25f, 0f, editorTypeControlGroup.width * 0.125f, editorTypeControlGroup.height);
		buttonTypeControl4 = new Rect(editorTypeControlGroup.width * 0.375f, 0f, editorTypeControlGroup.width * 0.125f, editorTypeControlGroup.height);
		buttonTypeControl5 = new Rect(editorTypeControlGroup.width * 0.5f, 0f, editorTypeControlGroup.width * 0.125f, editorTypeControlGroup.height);
		...
		buttonLine1 = new Rect(editorTypeControlGroup.width * 0.125f, editorTypeControlGroup.height * 0.05f, editorTypeControlGroup.width * 0.005f, editorTypeControlGroup.height);
		buttonLine2 = new Rect(editorTypeControlGroup.width * 0.25f, editorTypeControlGroup.height * 0.05f, editorTypeControlGroup.width * 0.005f, editorTypeControlGroup.height);
		buttonLine3 = new Rect(editorTypeControlGroup.width * 0.375f, editorTypeControlGroup.height * 0.05f, editorTypeControlGroup.width * 0.005f, editorTypeControlGroup.height);
		buttonLine4 = new Rect(editorTypeControlGroup.width * 0.5f, editorTypeControlGroup.height * 0.05f, editorTypeControlGroup.width * 0.005f, editorTypeControlGroup.height);
		...
		buttonPrev = new Rect((float)Screen.width * 0.29f, (float)Screen.height * 0.88f, (float)Screen.width * 0.015f, (float)Screen.height * 0.045f);
		buttonNext = new Rect((float)Screen.width * 0.305f, (float)Screen.height * 0.88f, (float)Screen.width * 0.015f, (float)Screen.height * 0.045f);
		socialRect = new Rect(sharingGroup.width * 0.02f, sharingGroup.height * 0.59f, sharingGroup.width * 0.56f, sharingGroup.height * 0.32f);
		buttonUndo = new Rect(sharingGroup.width * 0.05f, sharingGroup.height * 0.6f, sharingGroup.width * 0.5f, sharingGroup.height * 0.06f);
		buttonReset = new Rect(sharingGroup.width * 0.05f, sharingGroup.height * 0.66f, sharingGroup.width * 0.5f, sharingGroup.height * 0.06f);
		buttonFacebook = new Rect(sharingGroup.width * 0.05f, sharingGroup.height * 0.72f, sharingGroup.width * 0.5f, sharingGroup.height * 0.06f);
		buttonTwitter = new Rect(sharingGroup.width * 0.05f, sharingGroup.height * 0.9f, sharingGroup.width * 0.5f, sharingGroup.height * 0.06f);
		buttonMail = new Rect(sharingGroup.width * 0.05f, sharingGroup.height * 0.78f, sharingGroup.width * 0.5f, sharingGroup.height * 0.06f);
		buttonDownload = new Rect(sharingGroup.width * 0.05f, sharingGroup.height * 0.84f, sharingGroup.width * 0.5f, sharingGroup.height * 0.06f);
		textAreaRect = new Rect((float)Screen.width * 0.4f, (float)Screen.height * 0.5f, (float)Screen.width * 0.3f, (float)Screen.height * 0.05f);
		sendButtonRect = new Rect((float)Screen.width * 0.7f, (float)Screen.height * 0.5f, (float)Screen.width * 0.1f, (float)Screen.height * 0.05f);
		procesingRect = new Rect((float)Screen.width * 0.39f, (float)Screen.height * 0.5f, (float)procesing.width * 1f, (float)procesing.height * 1f);
	}
	...
	private void OnGUI()
	{
		...
		{
			SendMessage("TakeScreenShot", TypeSocialMedia.FACEBOOK);
		}
		...
		if (GUI.Button(buttonDownload, string.Empty, style.customStyles[17]))
		{
			SendMessage("TakeScreenShot", TypeSocialMedia.DOWNLOAD);
		}
		GUI.EndGroup();
		...
		if (GUI.Button(buttonTypeControl5, string.Empty, style.customStyles[1]))
		{
			changeType = ChangeType.ACCESORIES;
		}
		if (GUI.Button(buttonTypeControl6, string.Empty, style.customStyles[4]))
		{
			changeType = ChangeType.TOP;
		}
		if (GUI.Button(buttonTypeControl7, string.Empty, style.customStyles[10]))
		{
			changeType = ChangeType.BOTTOM;
		}
		if (GUI.Button(buttonTypeControl8, string.Empty, style.customStyles[7]))
		{
		...
		GUI.Label(buttonLine5, string.Empty, style.customStyles[8]);
		GUI.Label(buttonLine6, string.Empty, style.customStyles[8]);
		GUI.Label(buttonLine7, string.Empty, style.customStyles[8]);
		GUI.EndGroup();
			...
			case ChangeType.ACCESORIES:
			{
				for (int num3 = 0; num3 < 6; num3++)
				{
					for (int num4 = 0; num4 < 3; num4++)
					{
						...
						buttonChangeType1 = new Rect(editorOptionsGroup.width * 0.33f * (float)num4, editorOptionsGroup.height * 0.12f * (float)num3, (float)accesoriesThumbnails[accesoriesIndex].width * 0.3f, (float)accesoriesThumbnails[accesoriesIndex].height * 0.3f);
						if (GUI.Button(buttonChangeType1, string.Empty, style.customStyles[0]))
						{
		...
		else
		{
			...
			case ChangeType.HAIR:
			{
				for (int num21 = 0; num21 < 6; num21++)
				{
					...
					{
						hairIndex = hairSectionIndex * 18 + num21 * 3 + num22;
						if (editorContent.hairSkinnedList.Length <= hairIndex)
						{
							break;
						}
						buttonChangeType1 = new Rect(editorOptionsGroup.width * 0.33f * (float)num22, editorOptionsGroup.height * 0.12f * (float)num21, (float)hairProThumbnails[0].width * 0.3f, (float)hairProThumbnails[0].height * 0.3f);
						if (GUI.Button(buttonChangeType1, string.Empty, style.customStyles[0]))
						{
			...
			case ChangeType.FACIAL_DETAILS:
			{
				for (int num13 = 0; num13 < 6; num13++)
				{
					...
					{
						facialDetailsIndex = facialDetailsSectionIndex * 18 + num13 * 3 + num14;
						if (editorContent.facialDetailsTextureSkinnedList.Length <= facialDetailsIndex)
						{
							break;
						}
						buttonChangeType1 = new Rect(editorOptionsGroup.width * 0.33f * (float)num14, editorOptionsGroup.height * 0.12f * (float)num13, (float)facialDetailsProThumbnails[facialDetailsIndex].width * 0.26f, (float)facialDetailsProThumbnails[facialDetailsIndex].height * 0.26f);
						if (GUI.Button(buttonChangeType1, string.Empty, style.customStyles[0]))
						{
			...
			case ChangeType.SHOES:
			{
				for (int num17 = 0; num17 < 6; num17++)
				{
					...
					{
						shoesIndex = shoesSectionIndex * 18 + num17 * 3 + num18;
						if (editorContent.shoesSkinnedList.Length <= shoesIndex)
						{
							break;
						}
						buttonChangeType1 = new Rect(editorOptionsGroup.width * 0.33f * (float)num18, editorOptionsGroup.height * 0.12f * (float)num17, (float)shoesProThumbnails[0].width * 0.3f, (float)shoesProThumbnails[0].height * 0.3f);
						if (GUI.Button(buttonChangeType1, string.Empty, style.customStyles[0]))
						{
			...
			case ChangeType.ACCESORIES:
			{
				for (int num9 = 0; num9 < 6; num9++)
				{
					...
					{
						accesoriesIndex = accesoriesSectionIndex * 18 + num9 * 3 + num10;
						if (editorContent.accesorieSkinnedList.Length <= accesoriesIndex)
						{
							break;
						}
						buttonChangeType1 = new Rect(editorOptionsGroup.width * 0.33f * (float)num10, editorOptionsGroup.height * 0.12f * (float)num9, (float)accesoriesProThumbnails[accesoriesIndex].width * 0.3f, (float)accesoriesProThumbnails[accesoriesIndex].height * 0.3f);
						if (GUI.Button(buttonChangeType1, string.Empty, style.customStyles[0]))
						{
			...
			case ChangeType.TOP:
			{
				for (int num19 = 0; num19 < 6; num19++)
				{
					...
					{
						topIndex = topSectionIndex * 18 + num19 * 3 + num20;
						if (editorContent.topsSkinnedList.Length <= topIndex)
						{
							break;
						}
						buttonChangeType1 = new Rect(editorOptionsGroup.width * 0.33f * (float)num20, editorOptionsGroup.height * 0.12f * (float)num19, (float)topProThumbnails[topIndex].width * 0.3f, (float)topProThumbnails[topIndex].height * 0.3f);
						if (GUI.Button(buttonChangeType1, string.Empty, style.customStyles[0]))
						{
			...
			case ChangeType.BOTTOM:
			{
				for (int num15 = 0; num15 < 6; num15++)
				{
					...
					{
						bottomIndex = bottomSectionIndex * 18 + num15 * 3 + num16;
						if (editorContent.bottomsSkinnedList.Length <= bottomIndex)
						{
							break;
						}
						buttonChangeType1 = new Rect(editorOptionsGroup.width * 0.33f * (float)num16, editorOptionsGroup.height * 0.12f * (float)num15, (float)bottomProThumbnails[bottomIndex].width * 0.3f, (float)bottomProThumbnails[bottomIndex].height * 0.3f);
						if (GUI.Button(buttonChangeType1, string.Empty, style.customStyles[0]))
						{
			...
			case ChangeType.BACKGROUND:
			{
				for (int num11 = 0; num11 < 6; num11++)
				{
					...
					{
						backgroundIndex = backgroundSectionIndex * 18 + num11 * 3 + num12;
						if (editorContent.backgroundsTextureList.Length <= backgroundIndex)
						{
							break;
						}
						buttonChangeType1 = new Rect(editorOptionsGroup.width * 0.33f * (float)num12, editorOptionsGroup.height * 0.12f * (float)num11, (float)backgroundProThumbnails[backgroundIndex].width * 0.3f, (float)backgroundProThumbnails[backgroundIndex].height * 0.3f);
						if (GUI.Button(buttonChangeType1, string.Empty, style.customStyles[0]))
						{
			...
			case ChangeType.FACIAL_EXPRESSION:
			{
				for (int num7 = 0; num7 < 6; num7++)
				{
					...
					{
						facialExpressionsIndex = facialExpressionsSectionIndex * 18 + num7 * 3 + num8;
						if (expressionsProThumbnails.Length <= facialExpressionsIndex)
						{
							break;
						}
						buttonChangeType1 = new Rect(editorOptionsGroup.width * 0.33f * (float)num8, editorOptionsGroup.height * 0.12f * (float)num7, (float)expressionsProThumbnails[facialExpressionsIndex].width * 0.26f, (float)expressionsProThumbnails[facialExpressionsIndex].height * 0.26f);
						if (GUI.Button(buttonChangeType1, string.Empty, style.customStyles[0]))
						{
		...
		if (showMailBox)
		{
			...
			if (GUI.Button(sendButtonRect, "SEND", style.customStyles[20]))
			{
				...
				SendMessage("TakeScreenShot", TypeSocialMedia.MAIL);
				showMailBox = false;
			}
		}
	}
